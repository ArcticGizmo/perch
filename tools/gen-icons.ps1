...
#
#   src/Perch.App.Avalonia/Assets/icon.png   256x256 PNG  (window icons + in-app logo)
#   src/Perch.App.Avalonia/Assets/icon.ico   multi-res ICO (tray icon + .exe ApplicationIcon)
