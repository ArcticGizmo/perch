...
public sealed class SupabaseConfigTests
{
    ...
    public void IsConfigured_is_false_when_a_value_is_missing()
    {
        ...
        Assert.False(new SupabaseConfig("", "eyJtest").IsConfigured);
        Assert.True(new SupabaseConfig("https://demo.supabase.co", "eyJtest").IsConfigured);
    }
}
