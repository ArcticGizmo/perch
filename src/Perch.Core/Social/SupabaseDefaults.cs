...
/// <summary>
/// Compiled-in fallback for the Supabase URL + anon key — the last resort in <see cref="SupabaseConfig"/>,
...
/// <list type="bullet">
///   <item>the values are pasted here and committed — simplest, and acceptable because the anon key is
///     publishable and RLS is the real boundary; or</item>
...
/// </list>
/// Either way the key is only ever an <em>anon/publishable</em> key — never <c>service_role</c>.
/// </summary>
