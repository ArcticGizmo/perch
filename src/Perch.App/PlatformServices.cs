...
internal static class PlatformServices
{
    ...
    // "Who has the microphone" is entirely OS-specific (on Windows: the CapabilityAccessManager consent
    // ledger joined with WASAPI capture sessions), so it resolves like any other platform seam. The mac
